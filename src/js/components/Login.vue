  ...
  methods: {
    ...
    validateLogin(res) {
      return new Promise((resolve, reject) => {
        ...
        } else if (res.data && res.data.replies[0].SESSION_ID && res.data.replies[0].USER_ID) {
          // Set store state
          this.setSessionID(res.data.replies[0].SESSION_ID)
          this.setUserID(res.data.replies[0].USER_ID)
