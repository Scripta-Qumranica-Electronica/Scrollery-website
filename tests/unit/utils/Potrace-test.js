...
describe('Potrace.trace', () => {
    ...
    it ('should return an SVG path for a canvas with a circle', (done) => {
        ...
        testCanvas.width = 100
        testCanvas.height = 100
        const path = "M53.5 15.905 L 51.5 16.792 48.5 19.962 L 45.5 23.131 45.5 30.049 L 45.5 36.967 49.267 40.733 L 53.033 44.5 60 44.5 L 66.967 44.5 70.733 40.733 L 74.5 36.967 74.5 30 L 74.5 23.033 70.801 19.334 L 67.102 15.635 61.301 15.327 L 55.5 15.019 53.5 15.905 "
        let testCTX = testCanvas.getContext('2d')
        testCTX.fillStyle = 'purple'
        testCTX.beginPath()
